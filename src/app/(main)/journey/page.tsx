...
export default function JourneyPage() {
  ...
  const step = steps.find(s => s.id === currentStepId) || steps.find(s => s.status === 'in_progress') || steps[0];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-2">
        ...
        <p className="text-zinc-600">Track your progress and complete all requirements to become a ready voter.</p>
      </div>
